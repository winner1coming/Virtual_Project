<template>
    <g :transform="`translate(${power.offset[0]*power.scale}, ${power.offset[1]*power.scale}) scale(${power.scale})`" cursor="move">
        <path d="M38 20L61.3827 94.25L14.6173 94.25L38 20Z" stroke="rgba(0, 0, 0, 1)" stroke-width="10"   >
        </path>
        <path    stroke="rgba(0, 0, 0, 1)" stroke-width="12"    d="M38 94L38 124">
        </path>
        
        <!--选中方框-->
        <SelectedBox :x="14" :y="20" :width="48" :height="104" :visible="circuitStore.selectedId===props.id"/>
